    ...
    return (
        <WidgetTemplate className={"max-row-span-2"}>
            <EditorRoot>
                ...
                >
                    <EditorCommand className="z-50 h-auto max-h-[330px] w-72 rounded-md border border-main/60 bg-primary p-2 shadow-md transition-all">
                        <EditorCommandEmpty className="h-full flex items-center justify-center px-2 text-tertiary">No results</EditorCommandEmpty>
