...
export const status: Status[] = [
    ...
    { id: 'In Review', name: 'In Review', color: '#22c55e', icon: TechnicalReviewIcon },
    { id: 'Done', name: 'Done', color: '#8b5cf6', icon: CompletedIcon },
    { id: 'Canceled', name: 'Canceled', color: '#0ea5e9', icon: PausedIcon },
    { id: 'Todo', name: 'Todo', color: '#f97316', icon: ToDoIcon },
    { id: 'Backlog', name: 'Backlog', color: '#ec4899', icon: BacklogIcon },
]

export const StatusBadge: React.FC<{ statusId: string }> = ({ statusId }) => {
